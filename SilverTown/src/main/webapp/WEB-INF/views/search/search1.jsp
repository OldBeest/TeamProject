...
<head>
    ...
    var rowHtml = '<tr>' +
        '<td><img src="../images/hospital.jpg" alt="이미지"></td>' +
        '<td><strong>' + data.place_name + '</strong><br><small>' + data.address_name + '</small></td>' +
        '<td><a href="' + data.place_url + '" target="_blank">시설페이지(카카오)</a></td>' +
        '<td><a href="/search/search2?place_name=' + data.place_name + '&address=' + data.address_name +' " target="_blank">병원 페이지</a></td>' +
        '</tr>';
    ...
    <style>
        * {
        ...
        #hospital_info_table tbody tr {
        border-bottom: 1px solid #ddd;
        transition: background-color 0.3s;
    }
    #hospital_info_table tbody tr:hover {
        background-color: #f5f5f5;
    }
    #hospital_info_table tbody td {
        padding: 15px;
        vertical-align: middle;
    }
    
    #hospital_info_table tbody td img {
        max-width: 160px;
        height: auto;
        border-radius: 5px;
    }
    #hospital_info_table tbody td a {
        display: inline-block;
        padding: 5px 10px;
        background-color: #03C75A;
        color: white;
        ...
        #hospital_info_table tbody td a:hover {
