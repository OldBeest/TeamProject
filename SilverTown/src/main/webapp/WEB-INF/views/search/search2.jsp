		...
		<section id="contents">
				...
				<form>
					...
					<div class="initial-value-group">
						...
						<div class="input-group">
							...
							<h4><span class="promo-code" style="color : red">프로모션코드 입력 시 15%할인 적용!</span></h4>
			...
			function check_code() {
			    ...
			    if ((code == "silvertown") && (code_flag == false)) {
			        ...
			        document.querySelector(".promo-code").innerText = "프로모션 할인 코드가 적용되었습니다!";
			        document.querySelector(".promo-code").style.color = "blue";
			        // "예상비용" 텍스트를 "할인된 비용"으로 변경
			        document.querySelector(".result").innerHTML = 
			            '할인된 비용 : <span id="result">' + result.toLocaleString() + '</span> 원';
			        code_flag = true;
			    }
			}
			</script>
